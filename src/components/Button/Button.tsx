  ...
  return (
    <button
      ...
      className={classNames(
        "disabled:opacity-50 relative font-mono text-[15px] group/button flex items-center enabled:cursor-pointer justify-center font-medium gap-x-2 flex-shrink-0 gradient-border",

        // Sizes
        {
          "text-[10px] h-[20px] px-2 rounded-md": size === "xs",
    ...
    >
      {!isLoading ? (
        ...
        <Loading className="w-[18px] h-[18px]" />
      )}
    </button>
  );
}
